    ...
    <>
      ...
      >
        ...
        >
          <div className="flex visible lg:hidden p-5 items-center">
            ...
            <div className="w-4/6">
              <a
                href={NAVIGATION_ITEMS.SHOP}
                className="text-2xl ml-6 text-black"
              >
                ･*。 　 　･° 　　　°。 * 。 　　　　　　 ･°
              </a>
            </div>
            <div className="flex justify-center w-1/6">
              <a href={NAVIGATION_ITEMS.CART}>
                <svg
          ...
          >
            <a href={NAVIGATION_ITEMS.HOME} className="text-[black]">
              {NAVIGATION_TITLES.HOME}
            </a>
            <a href={NAVIGATION_ITEMS.SHOP} className="text-[black]">
              {NAVIGATION_TITLES.SHOP}
            </a>
            <a href={NAVIGATION_ITEMS.CONTACT} className="text-[black]">
      ...
      {!showMe && (
        <div className="flex visible lg:hidden p-5 items-center">
          ...
          <div className="w-4/6">
            <a href={NAVIGATION_ITEMS.SHOP} className="text-2xl ml-6">
              ･*。 　 　･° 　　　°。 * 。 　　　　　　 ･°
            </a>
          </div>
          <div className="flex justify-center w-1/6">
      ...
      >
        <div className="flex w-1/6 justify-evenly text-xs">
          <a href={NAVIGATION_ITEMS.HOME} className="mr-6">
            {NAVIGATION_TITLES.HOME}
          </a>
          <a
            href={NAVIGATION_ITEMS.SHOP}
